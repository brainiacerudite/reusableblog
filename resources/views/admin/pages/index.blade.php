                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="float-end d-flex">
                            @can('add pages')
                                <a class="btn btn-success waves-effect waves-light" href="{{ route('admin.pages.create') }}"
                                            ...
                                            <td style="white-space: nowrap">
                                                @can('edit pages')
                                                    <a class="btn btn-sm btn-info"
                                                        href="{{ route('admin.pages.edit', $data->id) }}"
                                                        role="button">Edit</a>
                                                @endcan
                                                @can('delete pages')
                                                    <button type="button" class="btn btn-sm btn-danger delBtn"
                                                        ...
                                                        data-delAction="{{ route('admin.pages.destroy', $data->id) }}">Delete</button>
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
