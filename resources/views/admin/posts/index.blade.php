                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="float-end d-flex">
                            @can('add posts')
                                <a class="btn btn-success waves-effect waves-light" href="{{ route('admin.posts.create') }}"
                                ...
                                <tbody>
                                    @foreach ($datas as $data)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $data->title }}</td>
                                            <td style="max-width: 100px;"><img src="{{ asset($data->image->image) }}"
                                                    alt="{{ $data->title }}" style="width: 100%; height: auto;"></td>
                                            ...
                                            <td style="white-space: nowrap">
                                                ...
                                                @can('delete posts')
                                                    <button type="button" class="btn btn-sm btn-danger delBtn"
                                                        ...
                                                        data-delAction="{{ route('admin.posts.destroy', $data->id) }}">Delete</button>
                                                @endcan
                                            </td>
                                        </tr>
                                    @endforeach
