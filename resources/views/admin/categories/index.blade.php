                    ...
                    <div class="col-md-4">
                        <div class="float-end d-flex">
                            @if ($rType === 'category')
                                @can('add categories')
                                    <a class="btn btn-success waves-effect waves-light"
                                        href="{{ route('admin.categories.create') }}" role="button"><i
                            ...
                            @if ($rType === 'tag')
                                @can('add tag')
                                    <a class="btn btn-success waves-effect waves-light"
                                        href="{{ route('admin.tags.create') }}" role="button"><i class="ti ti-plus"></i>
                                        Add</a>
                                @endcan
                            @endif
                        </div>
                                                ...
                                                @if ($rType === 'category')
                                                    ...
                                                    @can('delete categories')
                                                        <button type="button" class="btn btn-sm btn-danger delBtn"
                                                            ...
                                                            data-delAction="{{ route('admin.categories.destroy', $data->id) }}">Delete</button>
                                                    @endcan
                                                @endif
                                                @if ($rType === 'tag')
                                                    @can('edit tags')
                                                        <a class="btn btn-sm btn-info"
                                                            href="{{ route('admin.tags.edit', $data->id) }}"
                                                            role="button">Edit</a>
                                                    @endcan
                                                    @can('delete tags')
                                                        <button type="button" class="btn btn-sm btn-danger delBtn"
                                                            data-bs-toggle="modal" data-bs-target="#delModal"
                                                            data-delTitle="{{ $data->name }}"
                                                            data-delAction="{{ route('admin.tags.destroy', $data->id) }}">Delete</button>
                                                    @endcan
                                                @endif
                                            </td>
                                        </tr>
